...
RcppDisc <- function(vec, n = 5L, method = "natural", sample_begin = 3000L, sample_prob = 0.15, seed = 123456789L, threshold = 0.4, iter_step = 100L, breakpoints = numericVector(), right_closed = TRUE) {
